...
<div id="payment" class="woocommerce-checkout-payment mt-8">
  ...
  <ul class="wc_payment_methods payment_methods methods mb-8 flex flex-col gap-2">
  ...
  sprintf(
    ...
    '</em>',
      ...
      <br />
      <button type="submit" class="button alt{{ $btnClass ? ' ' . $btnClass : '' }}"
        name="woocommerce_checkout_update_totals" value="{{ esc_attr__('Update totals', 'woocommerce') }}">
