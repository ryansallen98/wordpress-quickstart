<div class="relative flex w-full flex-col justify-between lg:flex-row">
  ...
  <div class="flex flex-1 flex-col p-4 pt-0 lg:pt-4">
    ...
    <div class="mx-auto w-full flex-1 lg:max-w-[720px] lg:min-w-[560px] lg:p-12">
      {!! $right ?? '' !!}
      @empty($right)
        @stack('right')
      @endempty
    ...
    {{-- Legal Menu --}}
    <nav class="p-2 px-4 flex-wrap mt-4" aria-label="{{ __('Legal', 'sage') }}">
      <ul class="flex items-center flex-wrap gap-1 lg:gap-3">
