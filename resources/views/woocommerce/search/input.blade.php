    ...
    <form
      ...
      && event.target.value.length >= 3
        ...
        <div id="wcps-popover-wrap" :data-popper="isDesktop && popperOpen ? 'open' : 'closed'"
            ...
            class="lg:absolute lg:mt-2 w-full lg:data-[popper='open']:block lg:data-[popper='closed']:hidden animate-in fade-in zoom-in-90 top-[100%] overflow-hidden overflow-y-auto">
            <div id="wcps-popover"
                class="z-50 w-full overflow-hidden overflow-y-auto lg:rounded-md lg:border lg:bg-popover text-popover-foreground lg:shadow-md lg:max-h-[320px] lg:p-2 lg:pt-2 hidden has-[ul]:block has-[p]:block p-4 pt-0"
                aria-live="polite">
